...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        FluentWait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofMillis(250)).ignoring(NoSuchElementException.class);
